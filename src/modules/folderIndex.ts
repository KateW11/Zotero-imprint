...
import { throwIfStopped } from "../utils/cancel";
...
export async function folderIndex(
  ...
  for (const path of paths) {
    // The index feeds reconcile, whose answer is only meaningful whole, so a
    // stop here abandons rather than returning a short list.
    throwIfStopped();
